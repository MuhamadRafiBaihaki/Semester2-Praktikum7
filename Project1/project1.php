...
<head>
  ...
  <script>
    function validasi() {
            ...
            tgl_ = document.getElementById("tgl").value;
            nama_ = document.getElementById("nama").value;
            kode_ = document.getElementById("kode").value;
            gender_0 = document.getElementById("gender_0").value;
            gender_1 = document.getElementById("gender_1").value;
            bb_ = document.getElementById("bb").value;
            tb_ = document.getElementById("tb").value;
            
            if(tgl_ == "" || nama_ == "" || kode_ == "" || bb_ == "" || tb_ == "" ) {
                alert("Data Wajib Diisi Semua");
            }else{
                document.getElementById("action").action = `project1data.php`;
            }
    }
  </script>
</head>
...
<div class="wrapper">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tgl" name="tgl" placeholder="hari/bulan/tahun" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      <button name="submit" type="submit" onclick="validasi()" class="btn btn-primary">Submit</button>
    </div>
  </div>
</form>
