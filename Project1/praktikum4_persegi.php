  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Welcome to Praktikum 4 - Persegi </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-lg-12">
            <?php
              ...
              require_once "praktikum4/persegi/class_persegi.php";

              echo "Data Persegi Panjang dengan panjang lebar 8x5 adalah";

              $persegi_panjang = new Persegi(8,5);
